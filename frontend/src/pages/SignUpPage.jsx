...
const SignUpPage = () => {
  ...
  return (
    <div
      className="h-screen flex items-center justify-center p-4 sm:p-8"
      data-theme="coffee"
    >
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <p className="text-sm opacity-70">
                    Join Excitechat and learn languages from across the world
                  </p>
                </div>
        ...
        <div className="hidden lg:flex w-full lg:w-1/2 bg-primary/10 items-center justify-center">
          <div className="max-w-md p-8">
            <div className="relative aspect-square max-w-sm mx-auto">
              <img src="/main.png" alt="pic" className="w-full h-full" />
            </div>
